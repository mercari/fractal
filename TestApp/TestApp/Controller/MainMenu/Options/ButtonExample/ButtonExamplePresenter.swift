...
class ButtonExamplePresenter  {
    ...
    var staticNavOptions: [NavigationExampleEntity] = {
        let options = [NavigationExampleEntity.init(title: "Push to thing", intent: "navigationExample"),
                       NavigationExampleEntity.init(title: "Push to thing", intent: "navigationExample"),
                       NavigationExampleEntity.init(title: "Push to thing", intent: "navigationExample")]

...
public extension UIViewController {
    ...
    @discardableResult func contain(_ viewController: UIViewController, constraintBlock: ConstraintBlock? = nil) -> [NSLayoutConstraint] {
    ...
    func dismissContained(_ viewController: UIViewController?) {
    ...
    func dismissModalSelf(_ completion:(() -> Void)?) {
